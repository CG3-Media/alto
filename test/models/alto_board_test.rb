...
module Alto
  class BoardTest < ActiveSupport::TestCase
    # Use fixtures - they already provide users and status sets
    ...
    test "should require name" do
      board = Board.new(description: "No name", status_set: alto_status_sets(:default), item_label_singular: "ticket")
    ...
    test "should auto-increment slug for duplicate names" do
      first_board = Board.create!(name: "Unique Board", status_set: alto_status_sets(:default), item_label_singular: "ticket")
      assert_equal "unique-board", first_board.slug

      duplicate = Board.create!(name: "Unique Board", status_set: alto_status_sets(:default), item_label_singular: "ticket")
      assert_equal "unique-board-1", duplicate.slug
      assert duplicate.valid?
    end

    test "should have many tickets" do
      board = Board.create!(name: "Board with Tickets", status_set: alto_status_sets(:default), item_label_singular: "ticket")
    ...
    test "should have status tracking when status_set present" do
      board = Board.create!(name: "Board with Status", status_set: alto_status_sets(:default), item_label_singular: "ticket")
    ...
    test "should find available statuses" do
      board = Board.create!(name: "Status Board", status_set: alto_status_sets(:default), item_label_singular: "ticket")
    ...
    test "to_param should return slug" do
      board = Board.create!(name: "Test Board", status_set: alto_status_sets(:default), item_label_singular: "ticket")
