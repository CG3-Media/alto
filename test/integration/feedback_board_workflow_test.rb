...
class FeedbackBoardWorkflowTest < ActionDispatch::IntegrationTest
  def setup
  ...
  test "search functionality" do
    ...
    case_results = FeedbackBoard::Ticket.search("DARK")
    assert_includes case_results, ticket1
  end

  test "upvote uniqueness and deletion" do
    board = FeedbackBoard::Board.create!(name: "Vote Test", status_set: @status_set)
