module Alto
  class SubscribersController < ::Alto::ApplicationController
    ...
    def create
      result = SubscriptionService.call(:subscribe, @ticket, subscription_params[:email])
    ...
    def destroy
      result = SubscriptionService.call(:unsubscribe, @ticket, @subscription.email)
      ...
      if result.success?
        ...
        def unsubscribe
      result = SubscriptionService.call(:unsubscribe_user, @ticket, nil, current_user)
