class CreateFeedbackBoardV1 < ActiveRecord::Migration[7.0]
  def change
    ...
    add_index :feedback_board_status_sets, :name, if_not_exists: true
    add_index :feedback_board_status_sets, :is_default, if_not_exists: true
    ...
    add_index :feedback_board_statuses, :slug, if_not_exists: true
    add_index :feedback_board_statuses, [:status_set_id, :position], if_not_exists: true
    add_index :feedback_board_statuses, [:status_set_id, :slug], unique: true, if_not_exists: true
    ...
    add_index :feedback_board_boards, :name, if_not_exists: true
    add_index :feedback_board_boards, :slug, unique: true, if_not_exists: true
    ...
    add_index :feedback_board_tickets, :status_slug, if_not_exists: true
    add_index :feedback_board_tickets, :locked, if_not_exists: true
    add_index :feedback_board_tickets, :created_at, if_not_exists: true
    add_index :feedback_board_tickets, :title, if_not_exists: true
    add_index :feedback_board_tickets, :description, if_not_exists: true
    ...
    add_index :feedback_board_subscriptions, :email, if_not_exists: true
    add_index :feedback_board_subscriptions, [:ticket_id, :email], unique: true, if_not_exists: true
    ...
    add_index :feedback_board_settings, :key, unique: true, if_not_exists: true
  end
end
